...
try:
    ...
    # Define the criteria for deleting all documents (an empty filter matches all documents)
    query = {}

    # Delete all documents from the 'songs' collection
    result = songs_collection.delete_many(query)
